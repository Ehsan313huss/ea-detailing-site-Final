...
export default function Home() {
  ...
  // --- Car images ---
  const hyundaiImages = Array.from({ length: 6 }, (_, i) => `/Cars/Hyundai i30/${i + 1}.jpg`);
  const mitsubishiImages = Array.from({ length: 10 }, (_, i) => `/Cars/Mistubishi Outlander/${i + 1}.jpg`);
  const tritonImages = Array.from({ length: 6 }, (_, i) => `/Cars/Triton GS/${i + 1}.jpg`);
    ...
    <main className="bg-gray-50 text-gray-900">
      ...
      <section className="py-16 bg-white" id="services">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="mt-10 text-gray-500 text-sm max-w-2xl mx-auto">
            <strong>Note:</strong> Prices may vary depending on vehicle
            condition. Custom packages are also available upon request.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-6 bg-gray-100 text-center">
        ...
        <p className="max-w-3xl mx-auto text-lg">
          At EA Detailing, we bring the shine to you. Our mission is simple:
          provide top-quality car care with convenience and professionalism.
          Whether it’s a quick refresh or a deep detail, we treat every car like
          our own.
        </p>
      </section>
      ...
      <section id="contact" className="py-20 px-6 max-w-4xl mx-auto">
        ...
        {submitted ? (
          <div className="bg-green-100 text-green-800 p-6 rounded-2xl text-center shadow">
            ...
            <p>
              Thank you for booking with EA Detailing. We will contact you
        ...
        <div className="space-y-6 text-left">
          <details className="bg-gray-100 p-4 rounded-xl shadow">
            ...
            <p className="mt-2 text-gray-600">
              Depending on the vehicle’s condition, a full detail usually takes
              between 4–6 hours.
            </p>
          </details>
          <details className="bg-gray-100 p-4 rounded-xl shadow">
            ...
            <p className="mt-2 text-gray-600">
              Yes! We are a fully mobile detailing service — we come to your
              home or workplace.
            </p>
          </details>
          <details className="bg-gray-100 p-4 rounded-xl shadow">
      ...
      <footer className="bg-gray-900 text-white text-center py-10">
        ...
        <div className="space-y-2">
          ...
          <p>
            📧{" "}
            <a
              href="mailto:sitesbyehsan@gmail.com"
